...
function Services() {
  ...
  <div class="py-8 px-4 mx-60 max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 style={{
              ...
              }} class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{t('homeServicesHeader')}</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">{t('homeServicesDesc')}</p>
      </div>
